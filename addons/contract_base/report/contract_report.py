...
class ContractFundReportByCategory(osv.osv):
    _name = 'report.contract.fund_by_category'
    _description = 'Contract funds by catetory'
    _auto = False
    _columns = {
    ...
    def init(self, cr):
        ...
        cr.execute('''
            ...
            GROUP BY c.id, cat.name, c.start_date, c.end_date, c.sign_date, c.company_id

        ''')

ContractFundReportByCategory()
